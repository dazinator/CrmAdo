...
using CrmAdo.Tests.Support.EfModel;
...
namespace CrmAdo.Tests.Tests.EfTests
{
    ...
    [TestFixture]
    public class EntityFrameworkBasicTests : EntityFrameworkCodeFirstTestBase<BloggingContext>
    {
        ...
        protected override void SetUp()
        {
            using (var context = new BloggingContext(ConnectionString))
            {
                // Clear all existing data prior to start of test.
