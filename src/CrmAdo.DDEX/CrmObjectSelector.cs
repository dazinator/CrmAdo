...
namespace CrmAdo.DDEX
{
    ...
    internal class SqlObjectSelector : DataObjectSelector
    {
            ...
            object[] restrictions, string[] properties, object[] parameters)
        {
            ...
            CrmDbConnection conn = Site.GetLockedProviderObject() as CrmDbConnection;
            ...
            try
            {
                ...
                var comm = (CrmDbCommand)conn.CreateCommand();
                ...
                else if (typeName.Equals(CrmObjectTypes.ForeignKeyColumn,
                    StringComparison.OrdinalIgnoreCase))
                {
                    comm.CommandText = FormatSqlString(
